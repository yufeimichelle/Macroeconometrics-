...
IRFs.k1.hdi    = apply(IRF.posterior.mps,1:2,hdi, credMass=0.90)
hh          = 1:(h+1)
...
IRFs.k1.hdi_ext    = apply(IRF.posterior.mps_ext,1:2,hdi, credMass=0.90)
hh          = 1:(h+1)
